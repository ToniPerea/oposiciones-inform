# Lógica compartida por social-video.sh y social-video-intro-outro.sh:
# rutas de assets, constantes de timing y las funciones make_intro/make_outro
# (y make_main/concat_parts, usadas solo por social-video.sh).
#
# Requiere que el script que hace `source` de este fichero ya haya definido
# SCRIPT_DIR (carpeta scripts/) y REPO_ROOT (raíz del repo).
