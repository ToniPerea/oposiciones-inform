  ...
  readonly plans: Plan[] = [
    {
      ...
      badge: 'Pago único',
      features: [
        { text: 'Temario completo actualizado' },
        { text: 'Supuestos prácticos resueltos' },
        { text: 'Resúmenes y esquemas de cada tema' },
        { text: 'Flashcards para la memorización' },
        { text: 'Resúmenes en audio para escuchar cuando quieras' },
      ],
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Temas y criterios actualizados' },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Correcciones de temas incluidas' },
        { text: 'Corrección de supuestos prácticos incluida' },
